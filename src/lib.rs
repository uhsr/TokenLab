...
#[derive(Debug)]
pub struct TokenLabProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TokenLabProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TokenLab processing");
    
    let mut processor = TokenLabProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TokenLabProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TokenLabProcessor::new(false);
